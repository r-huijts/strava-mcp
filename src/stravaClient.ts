...
const StravaActivityKudoersResponseSchema = z.array(SummaryAthleteSchema);
...
export async function getActivityKudoers(
    ...
    try {
        ...
        return await handleApiError<StravaSummaryAthlete[]>(error, `getActivityKudoers for ID ${activityId}`, async () => {
            const newToken = process.env.STRAVA_ACCESS_TOKEN!;
